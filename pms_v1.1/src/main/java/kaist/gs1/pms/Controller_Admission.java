...
public class Controller_Admission{
	...
	public  @ResponseBody String test(ModelMap model) {
		...
		return "<Certificates><privateCertificate><X509Certificate>tttt</X509Certificate></private><pkiCertificate><X509Certificate>mmmm</X509Certificate><X509Certificate>ppp</X509Certificate></pki></Certificates>";
	}
}
