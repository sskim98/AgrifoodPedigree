...
<jsp:include page="common/header.jsp">
	...
	<link rel="StyleSheet" href="css/modal.css" type="text/css" />
		...
		<script type="text/javascript">
			...
			<c:forEach items="${events}" var="event"> // 모든 EPCIS 이벤트에 대하여
			var event = new Object();  // event 변수를 정의하고
			event.id = "${event._id}";  // 각 정보를 설정
			...
			<c:forEach items="${pedigrees}" var="pedigree">  // 모든 pedigree 정보에 대하여
			var pedigree = new Object();  // pedigree 변수를 선언하고 정보를 복사
			...
			$(document).ready(function() {
				...
				// DB에서 검색된 pedigree 들을 테이블형태로 변환하여 표시 
				function refresh_pedigree() {
					...
					for (var i = 0; i < pedigrees.length; i++) {
						if(i<10) {
							...
							$(tr).click(function() {
								//테이블 엔트리가 클릭되었을 때 엔트리 색을 변경하고 pedigree xml 정보를 표시
	...
	<div class="row">
		<div class="text-center col-sm-6">
			<div class="panel panel-default">
				<div class="panel-heading">EPCIS 이벤트 정보</div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<form class="form-horizontal" name="f" method="post" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'">
										<div class="form-group">
											<label for="inputSerialNumber" class="col-sm-3 control-label">코드</label>
											<div class="col-sm-6">
