		...
		<script type="text/javascript">
			...
			function partner_detail(obj) {
                for (var i = 0; i < partners.length; i++) {
                    ...
                    if (partner_id == partners[i].addressId) {
	...
	<jsp:param name="pageTitle" value="Menu"/>
	    ...
	    <div class="container">
	        <div class="row">
	                ...
	                <div class="panel panel-default">
	                    ...
	                    <div class="panel-body">
	                        ...
	                        <form class="form-horizontal" action="${homeUrl}/change_partner?${_csrf.parameterName}=${_csrf.token}" method="post" name="f" enctype="multipart/form-data" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'">
	                            ...
	                            <input name="action" class="btn btn-primary" type="submit" value="EPCIS Query" style="position:relative; margin-left:10px; margin-top:10px; float:inherit; width:40%;">
	                            <!-- 파트너 정보 직접 추가 -->
	                            <input name="action" class="btn btn-primary" type="submit" value="Add" style="position:relative; margin-left:10px; margin-top:10px; float:inherit; width:40%;">
	                            <!-- 파트너 정보 수정 -->
								<input name="action" class="btn btn-primary" type="submit" value="Change" style="position:relative; margin-left:10px; margin-top:10px; float:inherit; width:40%;">
								<!-- 파트너 정보 삭제 -->
								<input name="action" class="btn btn-primary" type="submit" value="Delete" style="position:relative; margin-left:10px; margin-top:10px; float:inherit; width:40%;">
				...
				<div class="panel panel-default">
					<!-- 파트너 리스트 표시 -->
					<div class="panel-heading">파트너 리스트</div>
					<div class="panel-body">
