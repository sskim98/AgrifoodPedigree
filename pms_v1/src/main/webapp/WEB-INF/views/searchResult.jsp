	...
	<link rel="StyleSheet" href="css/modal.css" type="text/css" />
		...
		<script type="text/javascript">
			...
			<c:forEach items="${traceInfo}" var="element">
				...
				element.eventTime = "${element.eventTime}";
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<span class="glyphicon glyphicon-question-sign"
								aria-hidden="true"></span> 수신한 Pedigree 검증 결과
						</div>
						<div id="verification_result" class="panel-body"
							style="font-size: 20px;">
							<p id="validation_false" style="color: red">
								<span class="glyphicon glyphicon-remove-circle"></span>
								Validation Fail
							</p>
							<p id="validation_true" style="color: green">
								<span class="glyphicon glyphicon-ok-circle"></span> Validation
								Success
							</p>
						</div>
					</div>
